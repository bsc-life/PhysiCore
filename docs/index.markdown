...
title: Home
nav_order: 1
description: "PhysiCore - A modern C++20 re-architecture of PhysiCell for high-performance multicellular simulations"
permalink: /
---
...
- [GitHub Repository](https://github.com/bsc-life/PhysiCore)
- [Latest Release](https://github.com/bsc-life/PhysiCore/releases/latest)
- [Issue Tracker](https://github.com/bsc-life/PhysiCore/issues)

## Contributing

PhysiCore is an open-source project. Contributions are welcome! See the [CONTRIBUTING.md](https://github.com/bsc-life/PhysiCore/blob/main/CONTRIBUTING.md) guide for details.
