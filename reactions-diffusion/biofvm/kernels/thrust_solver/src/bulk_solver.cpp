...
{
	std::size_t n = (dens_l | noarr::get_size()) / sizeof(real_t); // TODO

	thrust::for_each(thrust::make_counting_iterator<std::size_t>(0), thrust::make_counting_iterator<std::size_t>(n),
					 [=](std::size_t i) {
